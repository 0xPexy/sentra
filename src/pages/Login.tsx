...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E17] flex items-center justify-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-sm bg-[#151A28] p-6 rounded-xl border border-slate-800">
        ...
        <button className="w-full bg-indigo-600 hover:bg-indigo-500 rounded py-2 font-medium">Login</button>
      </form>
    </div>
  );
}